		...
		<div class="editor_block">
			<form action="<%=path %>/blog/${userid}/${essayid}/edit" method="POST">
	    		...
	    		<div class="title_input">
	    				<h4>标题：</h4>
	    				<input type="text" class="form-control input-lg"  name="title" value="${ essay.title }" id="editor_title" placeholder="请输入标题">
	    		</div>
   			    <div class="title_input">
    				<h4>标签：</h4>
    				<input type="text" class="form-control input-lg" name="label" value="${ essayLabels }" id="editor_label" placeholder="用逗号,分割开每个标签">
	    		</div>
	    		<!-- 文本编辑器 -->
